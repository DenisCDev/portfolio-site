...
const ProjectCard = ({ imgUrl, title, description, previewUrl }) => {
  return (
    <div className="rounded-xl shadow-lg overflow-hidden transition-transform transform hover:scale-105 duration-300">
      <div
      ...
      <div className="text-white rounded-b-xl mt-3 bg-[#181818] py-6 px-4 transition-colors duration-300 hover:bg-gray-800">
